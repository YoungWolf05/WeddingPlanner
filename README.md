...
Latest live evidence: [capability matrices](docs/capabilities/), [tool-call & structured-output contract matrices](docs/contracts/), [embedding & dimension compatibility](docs/embeddings/), and [evaluation baselines](docs/eval/) (each folder's `README.md` links the most recent dated snapshot).
